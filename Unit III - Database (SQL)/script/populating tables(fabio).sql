...
('38495672065','João Lima','21976543210','joao.lima@email.com','ingles','4.2'),
('12746530880','Maria Gonçalves','31965432109','maria.gon@email.com','espanhol','4.8'),
('52840361744','Roberto Souza','41954321098','roberto.souza@email.com','frances','4.0'),
('02596781476','Carla Dias','51943210987','carla.dias@email.com','italiano','4.3'),
('92635140898','Pedro Martins','61932109876','pedro.martins@email.com','alemao','4.7'),
('91705423841','Fernanda Rocha','71921098765','fernanda.rocha@email.com','russo','3.9'),
('19473268564','Lucas Mendes','81910987654','lucas.mendes@email.com','japones','4.1'),
('35289076140','Beatriz Correia','91909876543','beatriz.correia@email.com','chines','4.4'),
('37690215840','Rafaela Neves','11898765432','rafaela.neves@email.com','portugues','4.6');

INSERT INTO hospede (cpf, nome, email, telefone, forma_pagamento, avaliacao) 
VALUES 
('14863792573','Marcos Tavares','marcos.tav@email.com','21987654321','crédito','4.1'),
('80634271903','Julia Carvalho','julia.carv@email.com','31876543210','débito','4.3'),
('57123948637','Tiago Pereira','tiago.pere@email.com','41765432109','pix','4.5'),
('31498702678','Leticia Barbosa','leticia.barb@email.com','51654321098','crédito','3.8'),
('90726138487','Henrique Nogueira','henrique.nog@email.com','61543210987','débito','4.2'),
('43978160269','Amanda Freitas','amanda.freit@email.com','71432109876','pix','4.7'),
('10427658390','Bruno Cesar','bruno.cesar@email.com','81321098765','crédito','4.0'),
('48523971637','Vanessa Lima','vanessa.lima@email.com','91210987654','débito','4.4'),
('89104375610','Caio Moura','caio.moura@email.com','11109876543','pix','3.9'),
('85031429704','Patricia Soares','patricia.soares@email.com','21098765432','crédito','4.6');
...
VALUES
('2','2020-04-15','2020-04-20','1','14863792573'),
('4','2018-05-10','2018-05-15','2','80634271903'),
('1','2018-06-01','2018-06-03','3','57123948637'),
('3','2020-07-21','2020-07-25','4','31498702678'),
('2','2022-08-05','2022-08-10','5','90726138487'),
('5','2022-09-12','2022-09-19','6','43978160269'),
('2','2021-10-03','2021-10-05','7','10427658390'),
('4','2016-11-22','2016-11-30','8','48523971637'),
('1','2021-12-15','2021-12-18','9','89104375610'),
('3','2023-01-09','2023-01-15','10','85031429704');