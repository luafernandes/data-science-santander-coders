...
('12345678900','Ana Silva','11987654321','ana.silva@email.com','portugues','4.5'),
('23456789001','João Lima','21976543210','joao.lima@email.com','ingles','4.2'),
('34567890102','Maria Gonçalves','31965432109','maria.gon@email.com','espanhol','4.8'),
('45678901203','Roberto Souza','41954321098','roberto.souza@email.com','frances','4.0'),
('56789012304','Carla Dias','51943210987','carla.dias@email.com','italiano','4.3'),
('67890123405','Pedro Martins','61932109876','pedro.martins@email.com','alemao','4.7'),
('78901234506','Fernanda Rocha','71921098765','fernanda.rocha@email.com','russo','3.9'),
('89012345607','Lucas Mendes','81910987654','lucas.mendes@email.com','japones','4.1'),
('90123456708','Beatriz Correia','91909876543','beatriz.correia@email.com','chines','4.4'),
('01234567809','Rafaela Neves','11898765432','rafaela.neves@email.com','portugues','4.6');

INSERT INTO hospede (cpf, nome, telefone, email, forma_pagamento, avaliacao) VALUES
('21098765432','Marcos Tavares','21987654321','marcos.tav@email.com','crédito','4.1'),
('32109876543','Julia Carvalho','31876543210','julia.carv@email.com','débito','4.3'),
('43210987654','Tiago Pereira','41765432109','tiago.pere@email.com','pix','4.5'),
('54321098765','Leticia Barbosa','51654321098','leticia.barb@email.com','crédito','3.8'),
('65432109876','Henrique Nogueira','61543210987','henrique.nog@email.com','débito','4.2'),
('76543210987','Amanda Freitas','71432109876','amanda.freit@email.com','pix','4.7'),
('87654321098','Bruno Cesar','81321098765','bruno.cesar@email.com','crédito','4.0'),
('98765432109','Vanessa Lima','91210987654','vanessa.lima@email.com','débito','4.4'),
('09876543210','Caio Moura','11109876543','caio.moura@email.com','pix','3.9'),
('10987654321','Patricia Soares','21098765432','patricia.soares@email.com','crédito','4.6');
